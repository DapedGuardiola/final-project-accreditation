...
@section('content')
    <div class="container-fluid">
        ...
        @if ($isAdm || $isAng)
            ...
            <div class="callout callout-primary shadow-sm">
                <h5>Chart</h5>
                <p>Chart berikut menampilkan distribusi jenis kegiatan dan partisipasi peran dalam kegiatan.</p>
            </div>
            ...
            <div class="container-fluid mt-3">
                <div class="row mb-4">
                    <div class="col-md-6">
                        <div class="card shadow-sm">
                            <div class="card-header bg-primary border-bottom">
                                <h5 class="card-title mb-0 text-white">Distribusi Jenis Kegiatan</h5>
                                <div class="card-tools">
                            ...
                            <div class="card-body collapse">
                                <div class="row mb-4">
                                    <div class="col-md-12">
                                        <canvas id="pieChartJenisKegiatan"
                    ...
                    <div class="col-md-6">
                        <div class="card shadow-sm">
                            <div class="card-header bg-primary border-bottom">
                                <h5 class="card-title mb-0 text-white">Distribusi Peran Dalam Kegiatan</h5>
                                <div class="card-tools">
                                    <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                        <i class="fas fa-plus"></i>
                                    </button>
...
@push('scripts')
    ...
    {{-- Chart.js --}}
    <script>
        const jenisKegiatanLabels = @json($jenisKegiatanLabels);
        const jenisKegiatanData = @json($jenisKegiatanData);
        ...
        // Pie Chart - Distribusi Jenis Kegiatan
        const ctxPieJenis = document.getElementById('pieChartJenisKegiatan').getContext('2d');
        const pieChartJenisKegiatan = new Chart(ctxPieJenis, {
            type: 'pie',
            data: {
        ...
        // Bar Chart - Distribusi Peran Dalam Kegiatan
        const ctxBarPeran = document.getElementById('barChartPeran').getContext('2d');
        const barChartPeran = new Chart(ctxBarPeran, {
            type: 'bar',
            data: {
                labels: peranLabels,
                datasets: [{
