<form action="{{route('user.storePhoto') }}" method="POST" enctype="multipart/form-data" id="input-form">
    @csrf
        ...
        <div class="form-group text-center">
            <div class="form-group row">
                ...
                <img class="profile-user-img img-fluid img-circle mb-2"
                    src="{{asset('img/userAvatars/' . Auth::user()->id_user . '.png')}}" alt="User profile picture"
